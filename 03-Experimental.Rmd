...
```{r STschottky, echo = FALSE, fig.cap="STPS2H100ZFY Si Schottky diode manufactured by STMicroelectronics"}
...
The manufacturer STMicroelectronics provides a ZIP file containing many of their devices’ SPICE
model. 
...
Ensure that temperature is at 25◦C.
...
```{r EngaugeSTPS8H, echo = FALSE, fig.cap="Digitizing the25◦C V-I curve of the STPS8H100 diode"}
...
```{r VIcompDSSpice, echo = FALSE,  fig.cap="Comparison  of  the  STPS8H100  diode  V-I  curves  obtained  from  the  datasheet  and  the  device’s  SPICEMODEL."}
...
```{r VIdiodesetup, echo = FALSE, fig.cap="Experiment setup for diode characterization"}
...
```{r vidiodesim, echo = FALSE, fig.cap="Simplified simulation model for the diode."}
...
```{r vistall25, echo = FALSE, fig.cap="Comparison of the V-I Curves of the STPS8H100 diode at25◦C."}
...
```{r MOSBSR202N, echo = FALSE, fig.cap="BSR202N MOSFET manufactured by Infineon Technologies."}
...
```{r mosfetvisimp, echo = FALSE, fig.cap="Simplified model for a power MOSFET"}
...
```{r VIMOSFETSIMAmbient, echo = FALSE,  fig.cap="V-I curve from the manufacturer’s SPICEmodel of the IPA60R600P6 MOSFETas an example (again, it isa different device from BSR202N and is only shown as an example)"}
...
```{r VIMosfetsetup, echo = FALSE, fig.cap="Experimental setup to measure the V-I Curve of a MOSFET."}
...
```{r FQT4N25TF, echo = FALSE,  fig.cap="FQT4N25TF MOSFET manufactured by ON Semiconductor."}
...
```{r clampex, echo =FALSE, fig.cap="An example of how to clamp up the MOSFET onto the hot plate.  Remember to be very careful and uselots of Kapton tape to make sure nothing is shorting!"}
knitr::include_graphics("Figs/clamp_example.png", error = FALSE)
```


```{r vimosfetalltemp, echo = FALSE,  fig.cap="A comparison of the V-I Curves of the IPA60R600P6 at various temperatures."}
